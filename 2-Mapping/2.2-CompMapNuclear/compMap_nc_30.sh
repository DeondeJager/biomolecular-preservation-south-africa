...
# Execute paleomix
echo "$(date) Mapping sample PcA001..."
paleomix bam run paleomix_PcA001_compMap_nc.yaml --max-threads 10 --adapterremoval-max-threads 10 --bwa-max-threads 10 --temp-root ./temp.PcA001
echo "$(date) Done mapping sample PcA001."
